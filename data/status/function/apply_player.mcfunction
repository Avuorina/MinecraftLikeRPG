...
# HP割合計算: Heart = (hp/max_hp)*20
    ...
    scoreboard players operation @s _ /= @s max_hp
...
# def を装甲値に変換（DEF - 5 = 装甲、DEF 5 = 0装甲）
    ...
    execute if score @s _ matches 0.. store result entity @s attribute.minecraft:armor.base double 1 run scoreboard players get @s _
