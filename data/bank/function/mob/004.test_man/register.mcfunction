...
data modify storage rpg_mob: "ベース" set value {id:"minecraft:zombie",Tags:[MOB,mob.004.test_man,Init,Global,Debug,Blow,TestMan,ENEMY]}
...
summon minecraft:zombie ~ ~ ~ {Tags:[MOB,mob.004.test_man,Init,Global,Debug,Blow,TestMan,ENEMY], CustomNameVisible:1b, PersistenceRequired:1b}

execute as @e[tag=mob.004.test_man,tag=Init,distance=..1,limit=1] run function mob:setup/apply_from_storage
