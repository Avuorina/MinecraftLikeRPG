...
data modify storage rpg_mob: "ベース" set value {id:"minecraft:zombie",Tags:[MOB,mob.001.goblin,Init,Global,Ground,Blow,Goblin,ENEMY]}
...
summon minecraft:zombie ~ ~ ~ {Tags:[MOB,mob.001.goblin,Init,Global,Ground,Blow,Goblin,ENEMY], CustomNameVisible:1b, PersistenceRequired:1b}
