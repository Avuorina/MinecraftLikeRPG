...
data modify storage rpg_mob: "ベース" set value {id:"minecraft:skeleton",Tags:[MOB,mob.002.skeleton_warrior,Init,Global,Ground,Shoot,Blow,SkeletonWarrior]}

# 見た目
data modify storage rpg_mob: "見た目" set value {CustomName:[{"color":"white","text":"スケルトン戦士"},{"color":"gray","text":"Lv10"}]}
...
summon minecraft:skeleton ~ ~ ~ {Tags:[MOB,mob.002.skeleton_warrior,Init,Global,Ground,Shoot,Blow,SkeletonWarrior], CustomNameVisible:1b, PersistenceRequired:1b}
