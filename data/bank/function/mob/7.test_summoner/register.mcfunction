#> bank:mob/7.test_summoner/register
#
# テストサモナー データ登録
# ID: 7.test_summoner
#
# @within bank:mob/alias/7/register
...
data modify storage bank:mob Base.Tags set value {Tags:[Init,"7.test_summoner","HasTick","007.test_summoner","ENEMY"]}
