...
tellraw @s [{"bold":false,"color":"white","text":"| "},{"click_event":{"action":"run_command","command":"/trigger Menu set 1"},"color":"red","text":"♥"},{"bold":true,"click_event":{"action":"run_command","command":"/trigger Menu set 101"},"color":"white","hover_event":{"action":"show_text","value":[{"text":"HPを上昇させる","color":"yellow"}]},"text":"+1"},{"bold":false,"color":"dark_gray","text":"("},{"score":{"name":"@s","objective":"MaxHP"}},")","  ",{"color":"aqua","text":"✦"},{"bold":true,"click_event":{"action":"run_command","command":"/trigger Menu set 102"},"color":"white","hover_event":{"action":"show_text","value":[{"text":"MPを上昇させる","color":"yellow"}]},"text":"+1"},{"color":"dark_gray","text":"("},{"score":{"name":"@s","objective":"MaxMP"}},")"]